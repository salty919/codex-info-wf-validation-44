...
printf '%s\n' \
    '{"timestamp":"2026-08-27T00:00:00Z","type":"turn_context","model":"gpt-5.6-luna"}' \
    '{"timestamp":"2026-08-27T00:00:01Z","type":"token_count","payload":{"info":{"total_token_usage":{"total_tokens":10,"input_tokens":8,"cached_input_tokens":4,"output_tokens":2}}}}' \
    >"$session_file"
printf '%s\n' '{"reset_at":1788393600,"window_seconds":604800}' >"$reset_hint"
